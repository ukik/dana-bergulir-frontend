...
<div class="input-group">
	<form class="col-8" ref="form"  @submit.prevent="onSubmit"  @change="handleChange" @invalid.capture.prevent="handleInvalid">
	    ...
	    <b-col>
				<div class="input-group">
				<a >:</a>	<ui-register-survey-autocomplete-surveyor v-if="autocomplete" @onBubbleEvent="onBubbleEventProfileSurveyor" @onBubbleEventClear="onBubbleEventClearProfileSurveyor" class="col ml-2" />
				</div>
				<!-- Required -->
	    ...
	    <b-col>
				<div class="input-group">
				<a >:</a>	<ui-register-survey-autocomplete-proposal v-if="autocomplete" @onBubbleEvent="onBubbleEventProfileProposal" @onBubbleEventClear="onBubbleEventClearProfileProposal" class="col ml-2" />
				</div>
				<!-- Required -->
  ...
  name: 'ui-penerima-pemohon-content-tambah',
	...
	methods: {
		...
		onSubmit: window._.debounce(function() {
			...
			new Promise(resolve => {
				resolve(this.dispatch_survey_add_payload_items({
