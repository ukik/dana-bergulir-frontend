        ...
        <form class="col-8" ref="form" @submit.prevent="onSubmit" @change="handleChange" @invalid.capture.prevent="handleInvalid">
            ...
            <b-row class="mb-2">
                ...
                <b-col>
                    <div class="input-group">
                        :
                        <input disabled id="nomor_transaksi" name="nomor_transaksi" v-model="database.payload.nomor_transaksi" type="text" class="form-control ml-2 readonly" placeholder="">
                    </div>
                    <!-- Required -->
            ...
            <b-row class="mb-2">
                ...
                <b-col>
                    <div class="input-group">
                        :
                        <input disabled id="nama_pemilik" name="nama_pemilik" v-model="database.payload.nama_pemilik" type="text" class="form-control ml-2 readonly" placeholder="">
                    </div>
                    <!-- Required -->
            ...
            <b-row class="mb-2">
                ...
                <b-col>
                    <div class="input-group">
                        :
                        <input disabled id="pokok" name="pokok" v-model="database.payload.pokok" type="text" class="form-control ml-2 readonly" placeholder="">
                    </div>
                    <!-- Required -->
            ...
            <b-row class="mb-2">
                ...
                <b-col>
                    <div class="input-group">
                        :
                        <input disabled id="bunga" name="bunga" v-model="database.payload.bunga" type="text" class="form-control ml-2 readonly" placeholder="">
                    </div>
                    <!-- Required -->
            ...
            <b-row class="mb-2">
                ...
                <b-col>
                    <div class="input-group">
                        :
                        <input disabled id="bunga" name="denda" v-model="database.payload.denda" type="text" class="form-control ml-2 readonly" placeholder="">
                    </div>
                    <!-- Required -->
                    ...
                    preConfirm: () => {
                        ...
                        vm.$axios.get(ipAPI)
                            .then(function(response) {
                                ...
                                vm.dispatch_penagihan_piutang_add_payload_items({
                                    index
                                })
